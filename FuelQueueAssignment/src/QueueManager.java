...
//class for managing all the methods that is related to the fuel queues
public class QueueManager {

    private FuelQueue[] queues;

    //getting 5 fuelqueue objects using a loop
     ...
     */
    private void PrintCustomQueue(ArrayList<Passengers> customQueue) {
